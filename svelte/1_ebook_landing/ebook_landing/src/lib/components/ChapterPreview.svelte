...
<section class="py-12 mx-32">
  <h2 class="pb-10">What are you getting?</h2>
  <div class="grid grid-cols-[40%_55%] justify-between gap-12">
        <ul>
            ...
            <li>
                ...
                class:active={chapter.number === selectedChapterNumber}
                >
                    <h3>{chapter.title}</h3>
                </button>
            </li>
        ...
        <div>
            <h4 class="italic pb-12">{selectedChapter?.strapline}</h4>
